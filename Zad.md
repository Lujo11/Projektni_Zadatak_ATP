...
::: python
Hrvatska slova i drugi znakovilisting:tekst4
tekst = \"Python 3 radi bez problema s čžšćđ\"
print(tekst) python radi bez problema
s čžšćđ
:::
...
::: python
Dohvat dijelova tekstalisting:tekst_indeksiranje
tekst = \"Monty
Python i značenje života.\"
tekst\[0\] \# dohvati prvi znak 'M'
tekst\[1\] \# dohvati drugi znak 'o'
tekst\[0:5\] \#
dohvati znakove 0, 1, 2, 3, 4 'Monty'
tekst\[6:12\] \# dohvati
znakove 6, 7, 8, 9, 10, 11 'Python'
...
::: python
Izbacivanje znakova s početka i kraja tekstalisting:tekst7
tekst= '.! 2000 .!'
...
::: python
Novi redak i tabulator u tekstulisting:tekst8
tekst = 'Ovajtekstredaka'
...
, ï b́ez da ti znakovi imaju posebno značenje\"
...
::: python
Druge česte radnje s tekstomlisting:tekst_ostalo
...
\# prebroji koliko se puta pojavljuje neki tekst u duljem tekstz
